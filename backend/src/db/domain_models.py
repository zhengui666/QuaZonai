...
class ApprovalSnapshot(Base, TimestampMixin):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            "feedback_contract_version_id",
            "preflight_receipt_id",
            name="uq_approval_snapshot_lineage_without_p2l",
        ),
        UniqueConstraint(
            "id",
            "promotion_purpose",
        ...
        ForeignKeyConstraint(
            ...
            name="fk_approval_snapshot_promotion_lineage_without_p2l",
            ondelete="RESTRICT",
            use_alter=True,
        ),
    )
...
class HandoffOffer(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            "feedback_contract_version_id",
            "preflight_receipt_id",
            name="uq_handoff_offer_lineage_without_p2l",
        ),
        CheckConstraint(
        ...
        ForeignKeyConstraint(
            ...
            name="fk_handoff_offer_approval_lineage_without_p2l",
            ondelete="RESTRICT",
        ),
    )
