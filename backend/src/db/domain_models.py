Warning: truncated output (original token count: 44877)
Total output lines: 3787
...
class AlphaEvaluationForecast(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            "NOT IN ('nan', 'inf', '-inf', 'infinity', '-…4877 tokens truncated…    portfolio_program_id: Mapped[UUID] = mapped_column(Uuid, nullable=False)
