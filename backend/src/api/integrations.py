...
from plugins.contract import Capability
from plugins.runtime import resolve_plugin_path
from schema_validation import validate_schema_value
    ...
    *,
    ...
    try:
        result = subprocess.run(
            [str(_bundle_python(settings, bundle)), "-m", "quazonai.plugins.runtime_call"],
