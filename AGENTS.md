...
- 所有者已授权本机 Codex 直接编辑源码、测试、配置、脚本和文档，执行验证及 Git/GitHub 操作。
...
Issue #62 的完整产品范围仍为 DESIGN 的 W0–W8/T01–T42。维护 PR 合并不代表产品完成；迁移、完整链路、恢复、文档及受保护验收证据齐全后才能关闭 #62 或声明生产可用。

缺失、失败、取消、应执行却跳过、额度不足、未回复或仅 emoji 均不是通过。GitHub Codex 只用于 review；本机负责人编写修复与测试，push 后针对新 Head 重新请求 review。
