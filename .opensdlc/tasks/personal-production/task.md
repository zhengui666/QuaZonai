...
PR #87 owns subsequent committed-source CI, the actual linked-engine result and independent review. Compilation, preview records, controlled peers and syntax stand-ins do not prove account inference or market validity. Failed, cancelled, skipped, absent or old-Head checks are not passes.
