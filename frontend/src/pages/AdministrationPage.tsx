...
function PromotionPolicyVersionDialog() {
  ...
  return <Dialog.Root open={open} onOpenChange={setOpen}>
    ...
    <ResponsiveDialogContent maxWidth="760px">
      ...
      <Dialog.Description size="2">Each Alpha gate is explicit and ordered. This form creates Alpha policies only; Paper/Live policies require complete typed connection, feedback-contract, and preflight bindings through the canonical API.</Dialog.Description>
      <div className="qz-form-grid" style={{ marginTop: 18 }}>
