...
| T03–T09: native profiles/protocol/tools/Reviewer | [Codex](../../apps/server/tests/codex_native.rs), [MCP](../../apps/server/tests/mcp_authoring.rs), [Mission Worker](../../apps/server/tests/mission_worker.rs) | Controlled responses remain identified as such. Account-dependent execution is waived; native Thread/tool/business validation is not. |
