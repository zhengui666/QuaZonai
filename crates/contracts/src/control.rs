...
impl OperatorOperation {
    pub fn code(self) -> &'static str {
        match self {
            ...
            Self::AlphaEvaluate => "ALPHA_EVALUATE",
            Self::PortfolioBuild => "PORTFOLIO_BUILD",
            Self::PortfolioSimulate => "PORTFOLIO_SIMULATE",
            Self::ReleaseCreate => "RELEASE_CREATE",
            Self::ReleaseApprove => "RELEASE_APPROVE",
            Self::HandoffOffer => "HANDOFF_OFFER",
            Self::ApprovalRevoke => "APPROVAL_REVOKE",
            Self::PolicyAuthorize => "POLICY_AUTHORIZE",
            Self::PolicyRevoke => "POLICY_REVOKE",
            Self::ReleaseReject => "RELEASE_REJECT",
            Self::ReleaseReopen => "RELEASE_REOPEN",
            Self::CycleStart => "CYCLE_START",
            Self::IntegrationSecretRegister => "INTEGRATION_SECRET_REGISTER",
            Self::RuntimeProbe => "RUNTIME_PROBE",
            Self::DownstreamProbe => "DOWNSTREAM_PROBE",
            ...
            Self::ExecutionAssumptionsCreate => "EXECUTION_ASSUMPTIONS_CREATE",
    ...
    pub fn creates(self) -> bool {
        matches!(
            ...
            Self::IntegrationSecretRegister
                ...
                | Self::BriefCreate
                | Self::MandateCreate
                | Self::ExecutionAssumptionsCreate
                | Self::ProjectCreate
...
pub enum OperatorCommand {
    ...
    AlphaEvaluate(crate::evidence::AlphaEvaluateRequestV1),
    PortfolioBuild(Box<crate::portfolio::PortfolioBuildRequestV1>),
    PortfolioSimulate(crate::portfolio::CandidateSimulationRequestV1),
    PortfolioStudy(crate::portfolio::PortfolioStudyRequestV1),
    ReleaseCreate(crate::delivery::ReleaseCreateV1),
    ReleaseApprove(crate::delivery::ReleaseApproveV1),
    HandoffOffer(crate::delivery::HandoffOfferV1),
    ApprovalRevoke(crate::delivery::ApprovalRevokeV1),
    PolicyAuthorize(Box<crate::delivery::AutomationAuthorizeV1>),
    PolicyRevoke(crate::delivery::PolicyRevokeV1),
    ReleaseReject(crate::delivery::ReleaseRejectV1),
    ReleaseReopen(crate::delivery::ReleaseReopenV1),
    ...
    DownstreamProbe(crate::delivery::DownstreamProbeRequestV1),
    ...
    ExecutionAssumptionsCreate(Box<crate::execution_assumptions::ExecutionAssumptionsCreateV1>),
...
impl OperatorCommand {
    pub fn operation(&self) -> OperatorOperation {
        match self {
            ...
            Self::AlphaEvaluate(_) => OperatorOperation::AlphaEvaluate,
            Self::PortfolioBuild(_) => OperatorOperation::PortfolioBuild,
            Self::PortfolioSimulate(_) => OperatorOperation::PortfolioSimulate,
            Self::PortfolioStudy(_) => OperatorOperation::PortfolioSimulate,
            Self::ReleaseCreate(_) => OperatorOperation::ReleaseCreate,
            Self::ReleaseApprove(_) => OperatorOperation::ReleaseApprove,
            Self::HandoffOffer(_) => OperatorOperation::HandoffOffer,
            Self::ApprovalRevoke(_) => OperatorOperation::ApprovalRevoke,
            Self::PolicyAuthorize(_) => OperatorOperation::PolicyAuthorize,
            Self::PolicyRevoke(_) => OperatorOperation::PolicyRevoke,
            Self::ReleaseReject(_) => OperatorOperation::ReleaseReject,
            Self::ReleaseReopen(_) => OperatorOperation::ReleaseReopen,
            ...
            Self::DownstreamProbe(_) => OperatorOperation::DownstreamProbe,
            ...
            Self::ExecutionAssumptionsCreate(_) => OperatorOperation::ExecutionAssumptionsCreate,
    ...
    pub fn normalized_request(&self) -> Result<serde_json::Value, serde_json::Error> {
        match self {
            ...
            Self::AlphaEvaluate(v) => serde_json::to_value(v),
            Self::PortfolioBuild(v) => serde_json::to_value(v),
            Self::PortfolioSimulate(v) => serde_json::to_value(v),
            Self::PortfolioStudy(v) => serde_json::to_value(v),
            Self::ReleaseCreate(v) => serde_json::to_value(v),
            Self::ReleaseApprove(v) => serde_json::to_value(v),
            Self::HandoffOffer(v) => serde_json::to_value(v),
            Self::ApprovalRevoke(v) => serde_json::to_value(v),
            Self::PolicyAuthorize(v) => serde_json::to_value(v),
            Self::PolicyRevoke(v) => serde_json::to_value(v),
            Self::ReleaseReject(v) => serde_json::to_value(v),
            Self::ReleaseReopen(v) => serde_json::to_value(v),
            ...
            Self::DownstreamProbe(v) => serde_json::to_value(v),
            ...
            Self::ExecutionAssumptionsCreate(v) => serde_json::to_value(v),
