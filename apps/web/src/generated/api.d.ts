...
export interface paths {
    ...
    "/api/v2/approvals/{id}/revocations": {
        ...
        get: operations["list_approval_revocations"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v2/approvals/{id}/revoke": {
        ...
        get?: never;
        put?: never;
        post: operations["revoke_approval"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v2/auth/cli/devices/{id}": {
        ...
        put?: never;
        post?: never;
        delete: operations["revoke_cli_device"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/v2/handoffs/{id}/forward-window": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v2/migrations/reports/{id}/artifacts": {
        ...
        get: operations["list_historical_artifact_results"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v2/migrations/reports/{id}/artifacts/summary": {
        ...
        get: operations["get_historical_artifact_summary"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v2/migrations/reports/{id}/artifacts/{record}": {
        ...
        get: operations["get_historical_artifact"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v2/migrations/reports/{id}/artifacts/{record}/content": {
        ...
        get: operations["get_historical_artifact_content"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v2/projects/{id}/forward-observations": {
        ...
        get: operations["list_forward_observations"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v2/projects/{id}/wakes": {
        ...
        get: operations["list_wake_events"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        CliLoginResult: {
            device: components["schemas"]["CliDevice"];
            token: string;
        };
        /** @enum {string} */
        ...
        CommandResult_HandoffViewV1: {
            ...
            resource: {
                ...
                delivery_sequence: components["schemas"]["DbCounter"];
                downstream_id: components["schemas"]["Id"];
                environment: components["schemas"]["ForwardEnvironmentV1"];
                /** Format: date-time */
                expires_at: string;
        ...
        /** @enum {string} */
        ForwardClassificationV1: "HEALTHY" | "WATCH" | "DEGRADED" | "INSUFFICIENT_DATA";
        /** @enum {string} */
        ...
        ForwardObservationViewV1: {
            classification: components["schemas"]["ForwardClassificationV1"];
            /** Format: date-time */
            created_at: string;
            evaluation_id: components["schemas"]["Id"];
            id: components["schemas"]["Id"];
        ...
        /** @enum {string} */
        HandoffAckOutcomeV1: "ACKNOWLEDGED" | "REJECTED";
        HandoffAckV1: {
            external_ack_id: string;
            external_claim_id?: string | null;
            outcome: components["schemas"]["HandoffAckOutcomeV1"];
            reason: string;
            reason_code: string;
            schema_version: components["schemas"]["SchemaV1"];
        };
        ...
        /** @enum {string} */
        HandoffStateV1: "OFFERED" | "CLAIMED" | "ACKNOWLEDGED" | "REJECTED" | "REVOKED" | "EXPIRED";
        HandoffViewV1: {
            /** Format: date-time */
            acknowledged_at?: string | null;
            approval_id: components["schemas"]["Id"];
        ...
        /** @enum {string} */
        HistoricalArtifactOutcomeV1: "COPIED" | "MISSING" | "UNSUPPORTED" | "UNREADABLE" | "SEALED_RETAINED" | "MANUAL_REVIEW_REQUIRED";
        HistoricalArtifactResultV1: {
            byte_count?: null | components["schemas"]["DbCounter"];
            id: components["schemas"]["Id"];
            identity: components["schemas"]["HistoricalIdentityV1"];
            record_id?: null | components["schemas"]["Id"];
            report_id: components["schemas"]["Id"];
            source_outcome?: null | components["schemas"]["HistoricalArtifactOutcomeV1"];
            stored: boolean;
            verified_readable: boolean;
        };
        HistoricalArtifactSummaryV1: {
            projected_records: components["schemas"]["DbCounter"];
            readable_records: components["schemas"]["DbCounter"];
            report_id: components["schemas"]["Id"];
            schema_version: components["schemas"]["SchemaV1"];
            selected_records: components["schemas"]["DbCounter"];
            source_records: components["schemas"]["DbCounter"];
            stored_records: components["schemas"]["DbCounter"];
        };
        ...
        /** @description Old UUIDs are native UUIDs, not new-system UUIDv7 identities. */
        HistoricalIdentityV1: {
            kind: components["schemas"]["HistoricalKindV1"];
            /** Format: uuid */
            source_id: string;
            source_table: string;
        };
        ...
        /** @enum {string} */
        HistoricalKindV1: "RESEARCH" | "RUN" | "ARTIFACT" | "STRATEGY" | "EVALUATION" | "EVIDENCE" | "APPROVAL" | "HANDOFF";
        ...
        NativeModelRefV1: {
            ...
            schema_version: 1;
            /** @enum {string} */
            upstream_class: "nautilus_polymarket::models::PolymarketFeeModel";
            /** @enum {string} */
            upstream_version: "0.63.0";
        } | {
            /** @enum {string} */
        ...
        OperatorCommand: {
            ...
            request: components["schemas"]["HandoffOfferV1"];
        } | {
            /** @enum {string} */
        ...
        Page_HistoricalArtifactResultV1: {
            items: {
                byte_count?: null | components["schemas"]["DbCounter"];
                id: components["schemas"]["Id"];
                identity: components["schemas"]["HistoricalIdentityV1"];
        ...
        Page_WakeViewV1: {
            items: {
                consumed_cycle_id?: null | components["schemas"]["Id"];
                /** Format: date-time */
                created_at: string;
                id: components["schemas"]["Id"];
                /** Format: date-time */
                not_before: string;
                observation_id?: null | components["schemas"]["Id"];
                project_id: components["schemas"]["Id"];
                reason: string;
                revision: components["schemas"]["Revision"];
                state: components["schemas"]["WakeStateV1"];
                trigger: components["schemas"]["WakeTriggerV1"];
                /** Format: date-time */
                updated_at: string;
            }[];
            next_cursor?: null | components["schemas"]["Id"];
        ...
        /** @enum {string} */
        WakeTriggerV1: "DEGRADATION" | "DATA_AVAILABLE" | "OPERATOR" | "SCHEDULE";
        WakeViewV1: {
            consumed_cycle_id?: null | components["schemas"]["Id"];
            /** Format: date-time */
            created_at: string;
...
export interface operations {
    ...
    list_approval_revocations: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Page_ApprovalRevocationViewV1"];
                };
            };
            401: {
                headers: {
    ...
    revoke_approval: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ApprovalRevokeV1"];
            };
        };
        responses: {
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["CommandResult_ApprovalRevocationViewV1"];
                };
            };
            401: {
                headers: {
    ...
    cli_devices: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CliDevice"][];
                };
            };
            401: {
                headers: {
    ...
    cli_login: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CliLogin"];
            };
        };
        responses: {
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["CliLoginResult"];
                };
            };
            401: {
                headers: {
    ...
    offer_handoff: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["HandoffOfferV1"];
            };
        };
        responses: {
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["CommandResult_HandoffViewV1"];
                };
            };
            401: {
                headers: {
    ...
    get_handoff: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["HandoffViewV1"];
                };
            };
            401: {
                headers: {
    ...
    acknowledge_handoff: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["HandoffAckV1"];
            };
        };
        responses: {
            200: {
    ...
    get_forward_window: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ForwardWindowViewV1"];
                };
            };
            401: {
                headers: {
    ...
    list_historical_artifact_results: {
        parameters: {
            query?: {
                cursor?: components["schemas"]["Id"];
                limit?: number;
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Page_HistoricalArtifactResultV1"];
                };
            };
            401: {
                headers: {
    ...
    get_historical_artifact_summary: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["HistoricalArtifactSummaryV1"];
                };
            };
            401: {
                headers: {
    ...
    get_historical_artifact: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["HistoricalArtifactResultV1"];
                };
            };
            401: {
                headers: {
    ...
    get_historical_artifact_content: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_forward_observations: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Page_ForwardObservationViewV1"];
                };
            };
            401: {
                headers: {
    ...
    list_handoffs: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Page_HandoffViewV1"];
                };
            };
            401: {
                headers: {
    ...
    list_wake_events: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Page_WakeViewV1"];
                };
            };
            401: {
                headers: {
