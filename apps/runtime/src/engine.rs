    ...
    pub async fn image(&self, reference: &str) -> Result<NativeImage> {
        ...
        Ok(NativeImage {
            ...
            versions: BTreeMap::from([
                ...
                ("portfolio-calendar".into(), "1".into()),
